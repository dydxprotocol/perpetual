    ...
    P1Trade
{
    ...
    /**
     * @notice Once-only initializer function that replaces the constructor since this contract is
     ...
     * @param minCollateral The minimum allowed collateralization percentage.
     */

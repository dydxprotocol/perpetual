...
import p1FundingOracleInverterJson from '../../build/contracts/P1FundingOracleInverter.json';
...
export class Contracts {
  ...
  public p1FundingOracleInverter: Contract;
  ...
  constructor(
    ...
    this.p1FundingOracleInverter = this.addContract(p1FundingOracleInverterJson);
